 ...
 * 
 */
public class RotationView3 extends ImageView {
	private int width;
	private int height;
	private Paint paint;
	private RectF rectf;
	...
	public RotationView3(Context context) {
		this(context, null);
	}

	public RotationView3(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RotationView3(Context context, AttributeSet attrs, int defStyle) {
