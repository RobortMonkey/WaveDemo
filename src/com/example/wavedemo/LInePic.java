...
import com.example.wavedemo.MainActivityv.CallbackInterface;

public class LInePic extends View implements Runnable {
	private int vHeight;
	private int vWidth;
	...
	public LInePic(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public LInePic(Context context, AttributeSet attrs) {
		this(context, attrs, -1);
	}

	public LInePic(Context context) {
		this(context, null);
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (flag) {
			...
			{
				callbackInterface.viewMoveing(X,Y,X,YY2,vWidth,vHeight,surplusHeight,topsurplusHeight);
			}
