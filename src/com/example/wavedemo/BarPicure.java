...
public class BarPicure extends View implements Runnable {
	...
	public BarPicure(Context context, AttributeSet attrs, int defStyle) {
	...
	public BarPicure(Context context, AttributeSet attrs) {
		this(context, attrs,-1);
		 
	}

	public BarPicure(Context context) {
		this(context,null);
	}
	...
	protected void onDraw(Canvas canvas) {
		canvas.drawColor(Color.parseColor("#0da8d8"));
