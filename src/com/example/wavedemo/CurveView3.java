 ...
 */
public class CurveView3 extends View implements Runnable{
    ...
    public CurveView3(Context context) {
        this(context, null);
    }

    public CurveView3(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public CurveView3(Context context, AttributeSet attrs, int defStyleAttr) {
