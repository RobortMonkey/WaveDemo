...
public class DragGridView extends GridView implements OnItemLongClickListener {
	...
	private static final int DRAG_IMG_SHOW = 1;// 记录是否显示拖动时的imageview
	private static final int DRAG_IMG_NOT_SHOW = 0;
	private WindowManager.LayoutParams dragImageViewParams;
	private WindowManager windowManager;
	private int preDraggedOverPositon = AdapterView.INVALID_POSITION;// 长按时记录item的位置
	private static final float AMP_FACTOR = 1.2f;// 长按时显示的图片的倍数（相对于原来的item）
