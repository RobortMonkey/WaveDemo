 ...
 *
 */
public class BarPic extends View implements Runnable {
	...
	public BarPic(Context context, AttributeSet attrs, int defStyle) {
	...
	public BarPic(Context context, AttributeSet attrs) {
		this(context, attrs,-1);
		 
	}

	public BarPic(Context context) {
		this(context,null);
	}
