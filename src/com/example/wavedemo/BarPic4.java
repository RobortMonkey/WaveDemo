...
public class BarPic4 extends View implements Runnable {
	...
	public BarPic4(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public BarPic4(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public BarPic4(Context context) {
		super(context);
		init();
	}
